...
export default function UserManagementPage() {
  ...
  const mockUsers = [
    { id: 1, name: 'John Doe', email: 'john@example.com', status: 'Active', role: 'User', joinDate: '2024-02-15' },
    { id: 2, name: 'Jane Smith', email: 'jane@example.com', status: 'Active', role: 'Admin', joinDate: '2024-02-14' },
    { id: 3, name: 'Bob Johnson', email: 'bob@example.com', status: 'Inactive', role: 'User', joinDate: '2024-02-13' },
  ];
